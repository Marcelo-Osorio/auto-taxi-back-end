...
const config = {
  ...
  SECRET_JWT_REGISTER_KEY : process.env.SECRET_JWT_REGISTER_KEY,
  SECRET_JWT_ACCESS_KEY : process.env.SECRET_JWT_ACCESS_KEY,
  SECRET_JWT_REFRESH_KEY : process.env.SECRET_JWT_REFRESH_KEY,
  SECRET_JWT_RECOVER_KEY : process.env.SECRET_JWT_RECOVER_KEY,
